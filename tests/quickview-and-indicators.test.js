...
assert.match(core, /quickViewEnabled/);
assert.match(catalog.es.quickViewHint, /SUPER\+SHIFT\+↑/);
...
for (const lang of ['en', 'es']) {
  for (const key of ['workspaceIndicatorMode', 'workspaceIndicatorPadding', 'indicatorSquare', 'indicatorRounded', 'indicatorCircle', 'indicatorNone', 'quickView', 'quickViewHint']) {
